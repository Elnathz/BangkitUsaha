                    ...
                    if (docSnap.exists()) {
                        ...
                        setBusinessProfile((prev) => ({
                            ...
                            name:
                                ...
                                "Toko Saya",
                            owner:
                                data.ownerName || user.displayName || "Pemilik", // Ambil ownerName dari DB
    ...
    const stats = [
        {
            ...
            value: businessProfile.totalSales.toString(),
            icon: Award,
        },
        {
            label: "Rating",
            value: businessProfile.rating.toString(),
            icon: Star,
        },
        {
            label: "Ulasan",
            value: businessProfile.totalReviews.toString(),
            icon: Star,
        },
        {
            label: "Respon Rate",
            value: `${businessProfile.responseRate}%`,
            icon: Award,
        },
    ];
    ...
    const reviews = [
        {
            ...
            rating: 5,
            comment:
                "Keripik singkongnya enak banget! Renyah dan tidak terlalu berminyak.",
            date: "2025-12-01",
        ...
        },
        {
            ...
            rating: 5,
            comment:
                "Sambal matahnya seger, cocok buat lauk makan. Pasti order lagi!",
            date: "2025-11-28",
        ...
        },
        {
            ...
            rating: 4,
            comment:
                "Kue lapisnya enak, tapi harganya agak mahal. Overall recommended.",
            date: "2025-11-25",
        ...
        <div className="bg-gray-50 min-h-screen pb-6">
            ...
            <div className="px-4 pt-16">
                ...
                <div className="text-center mb-6">
                    ...
                    <h2 className="font-bold text-2xl capitalize text-gray-900 mb-1">
                    ...
                    <div className="flex items-center justify-center gap-1 text-orange-500 mt-1">
                        ...
                        <span className="text-gray-400 text-xs">
                            ({businessProfile.totalReviews} ulasan)
                        </span>
                    </div>
                </div>
                {/* --------------------------- */}
