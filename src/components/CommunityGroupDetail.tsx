import { ArrowLeft, Users, Settings, Heart, MessageCircle, Share2, Bookmark, CheckCircle, MoreHorizontal, Bell } from 'lucide-react';
...
export function CommunityGroupDetail({
  ...
  // Filter posts yang relevan dengan grup (mock - di real app filter berdasarkan group ID)
      ...
      <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-4 z-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-white/80">Grup Komunitas</p>
          </div>
          <button>
      ...
      <div className="p-4">
          ...
          <div className="px-4 pt-4 pb-4">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1 pt-2">
                <h2 className="font-semibold mb-1">{group.name}</h2>
              ...
              {isJoined ? (
                <>
                  <Button 
                    className="flex-1" 
                    size="sm"
                    onClick={() => toast.success('Notifikasi grup diaktifkan 🔔')}
                  >
                  ...
                  <Button 
                    ...
                    className="flex-1" 
                    size="sm"
                    onClick={() => toast.info('Membagikan grup...')}
                  >
        ...
        {groupPosts.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Belum ada post di grup ini</p>
          </div>
        )}
      </div>
