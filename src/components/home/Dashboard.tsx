...
import { TabType } from "../../App"; // Import tipe dari App
...
export function Dashboard({ onNavigate }: DashboardProps) {
    // State lokal hanya untuk overlay yang sifatnya sementara/modal
            ...
            <div className="px-4 -mt-4 pb-6">
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                    ...
                    >
                        ...
                        <p className="text-xs text-gray-600 mb-1">Keuangan</p>
                        <p className="text-blue-600 font-bold">{data.orders}</p>
                    </Card>
                    <Card
                        className="p-3 text-center cursor-pointer hover:bg-gray-50"
                        onClick={() => onNavigate("mystore")}
                    >
                        <Package className="w-6 h-6 text-purple-600 mx-auto mb-2" />
                        <p className="text-xs text-gray-600 mb-1">Stok Saya</p>
                        <p className="text-purple-600 font-bold">
                            {data.products}
                        </p>
                    </Card>
                    <Card className="p-3 text-center cursor-pointer hover:bg-gray-50">
